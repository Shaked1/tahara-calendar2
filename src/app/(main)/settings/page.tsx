        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>מידע אישי וחשבון</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-2">אימייל</label>
                <Input type="email" value={email} disabled className="bg-muted" />
                <p className="text-xs text-muted-foreground mt-1">לא ניתן לשנות את כתובת האימייל</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>בחירת שיטה הלכתית ותוספות</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-2">שיטה הלכתית</label>
                <select
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>להתאמת זמני זריחה ושקיעה</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-2">שם מיקום</label>
                <Input
                  type="text"
                  value={locationName}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-2">קו רוחב (Latitude)</label>
                  <Input
                    type="number"
                    step="0.0001"
                    value={latitude}
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">קו אורך (Longitude)</label>
                  <Input
                    type="number"
                    step="0.0001"
                    value={longitude}
